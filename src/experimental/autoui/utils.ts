...
import { BaseResource, Permissions } from './schemaOps';

export const getTagsDisabledReason = <T extends BaseResource<T>>(
	selected: T[],
	tagField: keyof T,
	t: TFunction,
) => {
...
export const getCreateDisabledReason = <T extends BaseResource<T>>(
...
export const getUpdateDeleteDisabledReason = <T extends BaseResource<T>>(
	selected: T[],
	hasOngoingAction: boolean,
